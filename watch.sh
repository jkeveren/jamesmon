...
# If this doesn't work, use "sudo setcap "cap_perfmon=pe" bin/syspect" to give syspect the perfmon capability https://man7.org/linux/man-pages/man7/capabilities.7.html
